...
if (isset($_POST['delete_id'])) {
    ...
    $consulta = "SELECT * FROM ad.usuario WHERE id = '" . $_POST['delete_id'] . "' LIMIT 1 ";
    ...
    <body>
      <div class="container1">
        <div class="centered-content1">
          ...
          <h4>Você tem certeza que deseja deletar o usuario '. $row_user['nome'] .'?</h4>
            <div class="submit">
    ...
    <script src="../js/deletarUsuario.js"></script>
